function   iug_load_wpr_rish(startTime, endTime, varargin)
%
% iug_load_wpr_rish(startTime, endTime, varargin)
% 
% (Input arguments)
%   startTime:          Start time (datetime or char or datenum)
%   endTime:            End time (datetime or char or datenum)
% (Options)
%   site:               Site name (ex., 'sgk' or {'sgk', 'bik', 'mnd', 'pon'})
...
%
% (Examples)
%   iug_load_wpr_rish('2006-4-1', '2006-4-8', 'site', 'sgk');
...
prefix = 'iug_wpr';
site_list = {'sgk', 'bik', 'mnd', 'pon'}; % ex. {'sta1', 'sta2', 'sta3'}
...
acknowledgement = sprintf(['If you acquire the Luneberg lens wind profiler radar (LL-WPR) data, \n',...
...
for ist=1:length(st_vec)
    ...
    for idt=1:length(dt_vec)
        ...
        for ipr=1:length(pr_vec)
            ...
            switch st
                case 'sgk'
                    url='http://www.rish.kyoto-u.ac.jp/radar-group/blr/shigaraki/data/data/ver02.0212/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                    relpath='iugonet/rish/misc/SITE/wpr/csv/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                case 'bik'
                    url='http://www.rish.kyoto-u.ac.jp/radar-group/blr/biak/data/data/ver02.0212/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                    relpath='iugonet/rish/misc/SITE/wpr/csv/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                case 'mnd'
                    url='http://www.rish.kyoto-u.ac.jp/radar-group/blr/manado/data/data/ver02.0212/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                    relpath='iugonet/rish/misc/SITE/wpr/csv/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                case 'pon'
                    url='http://www.rish.kyoto-u.ac.jp/radar-group/blr/pontianak/data/data/ver02.0212/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                    relpath='iugonet/rish/misc/SITE/wpr/csv/YYYYMM/YYYYMMDD/YYYYMMDD.PARAMETER.csv';
                otherwise
                    error('Such site name is not supported!');
            end
