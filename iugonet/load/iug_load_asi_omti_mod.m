function   iug_load_asi_omti_mod(startTime, endTime, varargin)
%
...
%********************************%
file_format = 'cdf';
url = 'http://ergsc.isee.nagoya-u.ac.jp/data/ergsc/ground/camera/omti/asi/SITE/YYYY/MM/DD/omti_asi_cPARAMETER_SITE_DATATYPE_YYYYMMDDhh_vVERSION.cdf';
prefix='omti_asi';
site_list = {'abu', 'ath', 'drw', 'eur', 'gak', 'hlk', 'hus', 'isg', 'ist', 'ith',...
             'kap', 'ktb', 'mgd', 'nai', 'nyr', 'ptk', 'rik', 'rsb', 'sgk', 'sta',...
             'syo', 'trs', 'yng'};
datatype_list = {'5577', '6300', '7200', '7774', '5893'};
parameter_list = {'??'};
...
%            end
            ...
            %relpath = 'iugonet/ergsc/ground/camera/omti/asi/SITE/YYYY/MM/DD/omti_asi_cPARAMETER_drw_DATATYPE_YYYYMMDDhh_vVERSION.cdf';
            ...
            relpath = 'iugonet/ergsc/ground/camera/omti/asi/SITE/YYYY/MM/DD/omti_asi_cPARAMETER_SITE_DATATYPE_YYYYMMDDhh_vVERSION.cdf';
            [file_url, file_relpath, file_local] = make_filelist_wildcard(url,...
                relpath, startTime, endTime, st, dt, pr, vs, rootpath);
            ...
            if downloadonly==0,
                ...
                if ~isempty(info)
                    ...
                    disp(' ');
                    disp('Rules of the Road for OMTI ASI Data Use:');
...
%                    alt = altitude';
                    ...
                    eval(['assignin(''base'', ''', varname_base, 'image'', ', 'image_raw);']);
                    eval(['assignin(''base'', ''', varname_base, 'time_cloud'', ', 'time_cloud);']);
                    eval(['assignin(''base'', ''', varname_base, 'could'', ', 'cloud);']);
