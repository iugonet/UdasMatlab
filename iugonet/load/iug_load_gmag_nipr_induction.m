function   [data, info]=iug_load_gmag_nipr_induction(startTime, endTime, varargin)
%
% [data, info]=iug_load_gmag_nipr_induction(startTime, endTime, varargin)
% 
% (Input arguments)
...
for ist=1:length(st_vec)
    ...
    switch st
        ...
        case 'syo'
            datatype_list = {'2sec', '20hz'};
        case 'isa'
            datatype_list = {'2sec'};
        otherwise
            error('Such site name is now allowed!');
    end
        ...
        for ipr=1:length(pr_vec)
            ...
            if downloadonly==0,
                ...
                if ~isempty(info)
                    ...
                    disp(' ');
                    disp('Rules of the Road for NIPR Induction Magnetometer Data:');
