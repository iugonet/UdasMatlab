function   iug_load_gmag_isee_fluxgate(startTime, endTime, varargin)
%
% iug_load_gmag_isee_fluxgate(startTime, endTime, varargin)
%
% (Input arguments)
...
%
% (Examples)
%   iug_load_gmag_isee_fluxgate('2013-1-1', '2013-1-2', 'site', 'msr');
%   iug_load_gmag_isee_fluxgate('2013-1-1', '2013-1-2', 'site', {'asb','kuj'});
%
...
for ist=1:length(st_vec)
    ...
    for idt=1:length(dt_vec)
        ...
        for ipr=1:length(pr_vec)
            ...
            relpath='ergsc/ground/geomag/isee/fluxgate/DATATYPE/SITE/YYYY/isee_fluxgate_DATATYPE_SITE_YYYYMMDD_vVERSION.cdf';
