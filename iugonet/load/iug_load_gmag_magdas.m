function   [data, info]=iug_load_gmag_magdas(startTime, endTime, varargin)
%
% [data, info]=iug_load_gmag_magdas(startTime, endTime, varargin)
% 
% (Input arguments)
...
%
% (Examples)
%   [data, info]=iug_load_gmag_magdas('2013-1-1', '2013-1-2', 'site', 'asb');
%   iug_load_gmag_magdas('2013-1-1', '2013-1-2', 'site', {'asb','kuj'}, 'fixed_varname', 1);
% 
