function   [data, info]=iug_load_asi_nipr(startTime, endTime, varargin)
%
% [data, info]=iug_load_asi_nipr(startTime, endTime, varargin)
% 
% (Input arguments)
...
%                       workspace. (ex., 'nipr_asi_tro_5577_image')
%
% (Output arguments)
...
%   iug_load_asi_nipr('2018-2-16 0:00', '2018-2-16 1:00', 'site', {'tro','lyr'}, 'wavelength', 'all', 'fixed_varname', 1);
% 
...
file_format = 'cdf';
url = ['http://iugonet0.nipr.ac.jp/data/asi/SITE/YYYY/MM/DD/nipr_asi_SITE_DATATYPE_YYYYMMDDhh_v0VERSION.cdf'];
...
for ist=1:length(st_vec)
    ...
    for idt=1:length(dt_vec)
        ...
        for ipr=1:length(pr_vec)
            ...
            relpath = 'iugonet/nipr/asi/SITE/YYYY/MM/DD/nipr_ask_SITE_DATATYPE_YYYYMMDDhh_v0VERSION.cdf';
