function   [data, info]=iug_load_brio_isee(startTime, endTime, varargin)
%
% [data, info]=iug_load_brio_isee(startTime, endTime, varargin)
% 
% (Input arguments)
...
%
% (Examples)
%   [data, info]=iug_load_brio_isee('2017-1-1', '2017-1-2', 'site', 'ath');
%   iug_load_brio_isee('2017-1-1', '2017-1-2', 'site', {'ath','kap'}, 'fixed_varname', 1);
% 
