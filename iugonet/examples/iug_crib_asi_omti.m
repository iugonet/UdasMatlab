...
%----- Load 1 site data -----%
iug_load_asi_omti('2012-9-4 11:00', '2012-9-4 11:10', 'site', 'drw', 'wavelength', '5577')

%----- Check the loaded data -----%
whos

%----- Display metadata -----%
disp_info(omti_asi_drw_5577_info);

%----- Pause -----%
input('Press any key.');

%----- Plot image -----%
disp(datevec(omti_asi_drw_5577_time(1)))

figure;

pcolor(squeeze(omti_asi_drw_5577_image(:,:,1)));
shading flat;
colormap(gray);
% set(gca, 'clim', [0, 250], 'dataaspectratio', [1,1,1]);
h=colorbar;
h.Label.String='counts';
title('557.7nm image at DRW at 11:00:00 UT');
